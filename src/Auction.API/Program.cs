...
using DotnetAuction.API.Repositories.DataAccess;
...
builder.Services.AddDbContext<DotnetAuctionDbContext>(options =>
{
    options.UseSqlite("Data Source=L:\\Workspace\\AuctionAPI\\AuctionDB.db");
});
